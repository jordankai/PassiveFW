...
function [traces,TT]=PassiveFW_onetype_roadside_love(dt,fmax,delka_t,source_number,S_R_Geo);
...
% Qs=[100 100 100];
% Qp=1.5*Qs;
% Damp_p = [0 0 0];%1./(2*Qp); % damping (hard-coded here ...)
% Damp_s = [0 0 0];%1./(2*Qs);
...
%**************************************************************************
%%%%%%%%%%%%  set point loads   %%%%%%%%%%%%%%%%%%%%%
Fx_flag=0; % point load in x-axis
Fy_flag=1; % point load in y-axis
Fz_flag=0; % point load in z-axis
